...
const ListPartners = ({ data }) => {
  return (
    <>
      <ul class="flex items-center justify-center md:justify-start [&_li]:mx-2 [&_li]:md:mx-4 [&_img]:max-w-none animate-infinite-scroll">
  ...
  return (
    <>
      ...
      {/* <div
        ...
        class="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_56px,_black_calc(100%-128px),transparent_100%)]  border border-red-500"
      >
