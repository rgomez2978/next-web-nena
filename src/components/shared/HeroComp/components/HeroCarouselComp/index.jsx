...
import ButtonComp from "@/components/shared/ButtonComp/index";
 ...
 * @returns
 */
const HeroCarouselSlide = ({ type, title, buttonText, imageUrl, cssClass }) => {
 ...
 * @returns
 */
const HeroCarouselComp = ({ data, cssClass, type, speed, autoplay, speedAutoplay, arrows, dots, slides }) => {
  return (
    <>
...
export default HeroCarouselComp;
